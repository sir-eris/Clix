...
export default function Projects() {
  const slides = [
    {
      subtitle: (
        <small className="text-xs text-gray-500 mb-2 block">
          Welcome to Projects!
        </small>
      ),
      title: (
      ...
      description: (
        <>
          ...
          <p className="text-sm mb-6">
            As the developer of this project, design each API Endpoint with the
            fact that your users will be calling it.
          </p>
        </>
      ),
      image: (
    ...
    },
    {
      ...
      description: (
        <p className="text-sm mb-6">
          ...
          something from the database (GET) or create a new record (POST), etc.
        </p>
      ),
      image: (
        <img
    ...
    },
    {
      ...
      description: (
        <p className="text-sm mb-6">
          ...
          smart UI will provide you with options based on the Method you choose.
        </p>
      ),
      image: (
        <img
